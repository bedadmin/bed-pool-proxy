...
class TemplateRegistry(object):
    ...
    def submit_share(self, job_id, worker_name, session, extranonce1_bin, extranonce2, ntime, nonce,
        ...
        header_bin = job.serialize_header(merkle_root_int, ntime_bin, nonce_bin, version_rolling)
        ...
        if hash_int > target_user:
            raise SubmitException("Share is above target %064x > %064x" %(hash_int, target_user))
