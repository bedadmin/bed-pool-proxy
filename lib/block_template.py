...
class BlockTemplate(halfnode.CBlock):
    ...
    def fill_from_rpc(self, data):
        ...
        coinbase = self.coinbase_transaction_class(coinbasetxn, settings.COINBASE_EXTRAS)
    ...
    def serialize_header(self, merkle_root_int, ntime_bin, nonce_bin, version_rolling):
    ...
    def is_valid(self):
        ...
        while len(hashes) > 1:
            ...
            hashes = newhashes
        calcwitness = SHA256(SHA256(hashes[0] + witness_nonce).digest()).digest()
